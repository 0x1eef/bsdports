...
@@ -56,10 +56,10 @@ async function npmInstallAsync(dir: string, opts?: child_proc
 		env: { ...process.env },
 		...(opts ?? {}),
...
@@ -88,7 +88,7 @@ async function npmInstallAsync(dir: string, opts?: child_proc
...
+		const output = await spawnAsync(npm, command, finalOpts);
 		if (output.trim()) {
